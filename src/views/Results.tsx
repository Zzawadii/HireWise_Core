...
import { BarChart3, ChevronDown, ChevronUp, Download, Filter, Sparkles, TrendingUp, TrendingDown, Minus, Loader2, Shield, Zap, MessageSquare, AlertTriangle, CheckCircle2 } from "lucide-react";
            ...
            <div className="space-y-6">
                ...
                <div className="flex gap-4 flex-wrap items-end">
                    ...
                    <Button onClick={handleScreenCandidates} disabled={screening || candidates.length === 0} className="shadow-sm">
                        {screening ? <Loader2 className="h-4 w-4 animate-spin" /> : <Zap className="h-4 w-4" />}
