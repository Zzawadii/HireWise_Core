...
import { Zap, Search, MessageSquare, TrendingUp, Star, Lightbulb } from "lucide-react";
...
const features = [
  ...
  { icon: Zap, title: "AI-Powered Matching", description: "Our AI evaluates your fit and gives you a compatibility score for each role." },
