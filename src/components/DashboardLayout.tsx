  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile top bar */}
        <header className="md:hidden flex items-center justify-between h-14 px-4 border-b border-sidebar-border bg-sidebar relative z-30">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sidebar-foreground text-sm">HireWise AI</span>
            </div>
          </div>
        ...
        {mobileOpen && (
          <>
            ...
            {/* Mobile nav drawer */}
            <div className="md:hidden fixed top-14 left-0 right-0 bg-sidebar border-b border-sidebar-border z-50 shadow-lg">
        ...
        <main className="flex-1 px-6 py-6 overflow-auto relative">{children}</main>
      </div>
    </div>
  );
};
